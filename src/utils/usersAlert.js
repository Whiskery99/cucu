...
const UserAlerts = () => {
    ...
    return (
        <>
            {showCard && (
                <div className="alert-container transform absolute left-20 top-[400px] transform flex flex-col justify-start mx-auto z-99 bg-[#fd961a] p-4 w-auto rounded-xl shadow-lg transition-transform duration-500 ease-in-out">
