            ...
            <div className="w-full">
                ...
                <div className="px-6 flex flex-col md:flex-row items-center md:justify-between gap-10 justify-center my-8 md:my-40 md:mt-[240px]">
                    ...
                    <div className="flex flex-col space-y-5 w-2/3 text-base px-6">
                        ...
                        <p>
                            At SuperIndexTradeFx, we believe that transparency is key to building trust with our clients. That's why we provide regular performance reports and open communication channels to keep our clients informed and engaged in the investment process.
                        </p>
                        <p>
                        ...
                        <p>
                            At SuperIndexTradeFx, we are committed to delivering exceptional investment management services that help our clients achieve their financial objectives. Contact us today to learn more about how we can help you succeed in the world of investing.
                        </p>
                    </div>
                </div>
                <Footer />
