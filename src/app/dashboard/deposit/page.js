                ...
                <div className="flex flex-col w-full mt-5 mx-0 mb-0 border-[0.5px] rounded-sm border-gray-200">
                    <div className="border-b-[1px] border-gray-600">
                        <div className="flex items-center px-4 py-6 justify-between">
                            ...
                            <button className="bg-[#fd961a] px-3 py-3 text-white text-sm tracking-wide rounded-md">Deposit History</button>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-4 px-4 pt-8 pb-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <select className="border placeholder-gray-500 focus:outline-none focus:border-black w-full p-4 mx-0 mb-0 text-base block bg-white border-gray-300 rounded-lg" onChange={(e) => {
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="border placeholder-gray-500 focus:outline-none focus:border-black w-full p-4 mx-0 mb-0 text-base block bg-white border-gray-300 rounded-lg">{selectedWallet?.walletAddress || "Select a wallet"}</p>
                        </div>
                        {/* // )} */}
                        <div className="flex flex-col gap-2">
