  ...
  return (
    <div className="flex">
      {isMobile ? (
        ...
        <div className="left-0 right-0 top-0 bottom-0 relative right-0 flex flex-2 flex-col gap-8 border border-l-0 border-t-0 border-r-1 w-full md:flex-1 left-0 md:left-[220px] overflow-x-auto overflow-scroll px-4 customized-scrollbar">
      ...
      <div className="fixed right-0 flex flex-2 flex-col border border-l-0 border-t-0 border-r-1 w-5/6 h-screen pt-3 px-4">
