...
export default function About() {
    return (
        <div className="w-full">
            ...
            <div className="h-[18vh] bg-[#fd961a] flex flex-col items-center gap-4 justify-center overflow-hidden">
                ...
                <p className="text-[#000] text-base px-4">We have been pioneering the industry in Europe for 20 years, and delivering value
            ...
            <div className="w-full px-4 grid grid-cols-1 md:grid-cols-2 mx-auto items-center md:items-center  gap-3 justify-center my-8 md:mt-10">
                ...
                <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                    <div class="grid gap-4">
                        ...
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="./img-about-2.jpg" alt="" />
                        </div>
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="./img-about-3.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
