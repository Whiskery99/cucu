...
export default function Footer() {
    return (
        ...
        <footer className="w-full bg-[#111] border-t-[0.5px] border-gray-200 sm:mx-auto">
            <div className="mx-auto w-full px-6 p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <img src="./logos.png" className="h-8 w-auto mr-1" alt=" Logo" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-[#fd961a] uppercase">Follow us</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-[#fd961a] uppercase">Legal</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="#" className="text-[#fd961a] hover:text-gray-900 dark:hover:text-white">
                            <svg className="w-4 h-4 text-[#fd961a]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                            </svg>
                            <span className="sr-only text-white">Facebook page</span>
                        </a>
                        <a href="#" className=" text-[#fd961a] hover:text-gray-900 dark:hover:text-white ms-5">
