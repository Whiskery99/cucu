...
export default function StartInvestment({ plan, onClose }) {
    ...
    return (
        <div className="w-screen h-screen fixed bottom-0 left-0 bg-[rgba(39,39,39,0.47)] z-50 grid place-items-center md:h-screen">
            <div className="bg-white flex flex-col space-y-6 w-[320px] md:w-[520px] p-4 mt-20 mx-0 mb-0 rounded-lg">
                <div className="border-b-[1px] border-gray-600">
                    <div className="flex items-center px-4 py-6 justify-between">
                        ...
                        <button className="bg-[#fd961a] px-3 py-3 text-white text-sm tracking-wide rounded-md" onClick={onClose}>Close</button>
                    </div>
                </div>
                ...
                <button onClick={handleInvestment} className="mt-1.5 inline-block bg-[#fd961a] py-4 rounded-lg px-5 font-medium tracking-wide text-white">Start Investment</button>
            </div>
            <Notifications />
        </div>
    )
