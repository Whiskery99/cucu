            ...
            <div>
                <div className="w-full mt-6 mx-0 mb-0 space-y-6">
                    ...
                    <div className="flex gap-8 flex-col">
                        ...
                        <button className="disabled:opacity-50 flex items-center justify-center bg-[#fd961a] px-6 py-4 text-lg tracking-wide text-white transition-all ease-in-out duration-200 font-medium focus:shadow rounded-md mt-4" onClick={handleCreateWallet}>
