...
export default function ProfileDetails({ userImage, userName, userEmail, userID, userBalance, state, country }) {
    UserDetailsContext();
    ...
    return (
        <>
            <div className="bg-white shadow-xl p-3 space-y-10 rounded-lg">
                {/* Content for Profile Details tab */}
                <div className="border-t-2 border-cyan-600 rounded-t-lg py-5 shadow-lg">
                    <div className="flex flex-col items-center">
                        <div className="w-40 h-40">
                            <img className="object-cover rounded-full border-[0.3px] border-gray-500 " src={userImage || 'Profile'} width={300} height={300} alt={userName} />
                        </div>
